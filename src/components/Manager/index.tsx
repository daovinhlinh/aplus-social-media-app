...
const ManagerContainer = () => {
   return (
      <Flex width="100%" flexDirection="column" pt={5}>
         ...
         >
            <Flex width="100%" bgColor="#fff" height="5vh" py="10px" px="20px" shadow="base" borderRadius={15}>
               <Box width="30%" marginLeft={35} fontWeight="bold" alignItems="center">
                  Họ và tên
               </Box>
            ...
            </Flex>
            {
               featureList.map((item) => (
                  <CardManager label={item.title} label1={item.text1} label2={item.text2} label3={item.text3} img={item.img} rightIcon={item.icon2} marginTop={5} onClick={() => { }} />
               ))
            }
         </Box>

                ...
                <Box bg="rgba(250, 250, 251, 1)" boxShadow='base' width="100%" minWidth="300px" px="10px" py="30px"
                    ...
                    </Box>
                    {
                        detailcards.map((item) => (
                            <DetailCard label2={item.title2}  label1={item.title1} leftImg={item.img} rightIcon={item.icon} onClick={() => { }}
                            ...
                            width= '38%' marginLeft = {16} marginBottom = {8} border = '1px solid #E5E5E5' borderRadius = {10}
                            />
                        ))
                    }
                </Box>
